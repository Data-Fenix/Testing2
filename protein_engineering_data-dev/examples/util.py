...
# ======================================================
print("============================")
print(f"=== adding target summary variable to a dataset ===")
dataset = dataset.add_column("target summary variable", get_summary_variable(dataset))

# ======================================================
print("============================")
print(f"=== adding target summary variable to a dataset - with objective ===")
dataset = ds.Dataset.from_dict(
    {
