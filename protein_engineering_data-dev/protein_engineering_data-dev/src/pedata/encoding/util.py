...
def find_function_order(
    ...
    if not satisfy_all:
        ...
        for encoding in encodings:
            ...
            if any(provided_enc.startswith("aa") for provided_enc in provided_encodings):
                # If any Amino Acid encoding exists in provided_encodings, exclude DNA encodigs
                ...
                # If any DNA encoding exists in provided_encodings, exclude AA encodigs
